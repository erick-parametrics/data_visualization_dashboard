...
/**
 * Create the color design tokens using Tailwind shades extensions.
 * Type the HEX code - highlight the HEX code - cmd+k+g)
 */
...
/**
 * MUI theme settings - dark mode or light mode
 * Anytime MUI typography is used, the font for each
 * tag is set below.
 */
